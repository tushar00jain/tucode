...
export function isSCMHistoryItemChangeNode(element: unknown): element is IResourceNode<SCMHistoryItemChangeViewModelTreeElement, SCMHistoryItemViewModelTreeElement> {
