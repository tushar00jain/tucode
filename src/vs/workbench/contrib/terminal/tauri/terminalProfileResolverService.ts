...
/**
 * Copy of `electron-browser/terminalProfileResolverService.ts`. Nothing in it is Electron's —
 * both halves of the host it hands the base service are `ITerminalInstanceService` lookups —
 * so the only substitution is the name.
 */
export class TauriTerminalProfileResolverService extends BaseTerminalProfileResolverService {
